...
function GetTradeoffProfitFixKnowTleaf(parts, envir, up_p, down_p, histories, legacies, esfactor, tleaf)
    ...
    # get leaf temperature and reset gmax, leaf temperature is from setting
    tem_l = tleaf #GetLeafTemperature(tem_a, speed, leaf_w, emol, r_abs)
    ...
    if vpd <= 0
        ...
        # whenever possible
            ...
            gain = GetTradeoffPhotosyntheticGainNet(para, light, g_tree/esfactor*leaf_g/gmax25)
